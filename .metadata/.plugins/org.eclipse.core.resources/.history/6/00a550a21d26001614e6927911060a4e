...
public class AopTest {
	public static void main(String[] args) throws SQLException {
		/*annotation을 사용한 Aop 적용*/
		ApplicationContext context = new ClassPathXmlApplicationContext("/com/kitri/aop/step06/config/applicationContext.xml");
